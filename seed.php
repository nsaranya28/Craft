...
(1, 'Customer Jane', 'user@craft.com', '\$2y\$10\$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi')"); // password: password

// Admins
$pdo->exec("INSERT IGNORE INTO admins (id, name, email, password, role) VALUES 
(1, 'Admin User', 'admin@craft.com', '\$2y\$10\$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'superadmin')");
